...
const MaintenanceInProgress: FC<IProps> = () => {
  ...
  return (
    <div className="text-black flex flex-col font-semibold text-lg justify-center bg-white px-5 rounded-lg h-fit py-4 lg:w-[19rem] lg:-translate-x-4 lg:-translate-y-4 translate-x-0 sm:rounded-lg sm:text-xl w-full sm:my-4">
