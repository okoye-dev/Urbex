...
const MaintenenceCompletionStatus: FC<IProps> = () => {
  return (
    <div className="bg-blue rounded-lg p-3 flex flex-col h-[16rem] justify-between items-center relative sm:w-full">
      ...
      />
      <span className="text-center text-white/50 text-[0.65rem] rounded-full border-2 border-white/50 p-[12px] aspect-square flex flex-col justify-center items-center">
        <p className="text-white font-semibold text-xl">60%</p> Completed
      </span>

      <div className="flex justify-center items-center text-[0.5rem] gap-6">
        <span className="flex flex-col">
          <h1 className="text-xl font-semibold">20</h1>
          <p>Due for maintenance</p>
        </span>
        <span className="w-[2px] h-3/5 top-[20%] bg-white/20"></span>
        <span className="flex flex-col">
          <h1 className="text-xl font-semibold">25</h1> <p>Ongoing</p>
        </span>
      </div>
    </div>
  );
